...
import { ArrowUpRight, ArrowDownRight, Activity, Users, Share2, MousePointerClick } from 'lucide-react';
    ...
    <div className="space-y-8 pb-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-lg">Measure your content performance and audience growth.</p>
        </div>
        <div className="flex gap-2">
          ...
          <button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white px-4 py-2 rounded-xl font-medium shadow-glow transition-all">
            Export Report
          </button>
        </div>
      </div>
        ...
        {stats.map((stat, idx) => {
          ...
          return (
            <motion.div
              ...
              className="glass-card p-5 rounded-2xl border-white/5 hover:border-white/10 transition-all group"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="mb-6">
            <h2 className="text-xl font-bold text-white">Engagement vs Views</h2>
